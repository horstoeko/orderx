...
BatchMarkDownGenerator::generate([
    OrderDocument::class => dirname(__FILE__) . '/Class-OrderDocument.md',
    OrderSettings::class => dirname(__FILE__) . '/Class-OrderSettings.md',
    OrderDocumentBuilder::class => dirname(__FILE__) . '/Class-OrderDocumentBuilder.md',
    OrderDocumentReader::class => dirname(__FILE__) . '/Class-OrderDocumentReader.md',
    OrderDocumentPdfReader::class => dirname(__FILE__) . '/Class-OrderDocumentPdfReader.md',
    OrderDocumentPdfBuilder::class => dirname(__FILE__) . '/Class-OrderDocumentPdfBuilder.md',
    OrderDocumentPdfMerger::class => dirname(__FILE__) . '/Class-OrderDocumentPdfMerger.md',
    OrderDocumentValidator::class => dirname(__FILE__) . '/Class-OrderDocumentValidator.md',
    OrderXsdValidator::class => dirname(__FILE__) . '/Class-OrderXsdValidator.md',
], []);
